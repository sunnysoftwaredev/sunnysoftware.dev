...
import styles from './AboutUsTop.scss';
import leftImage from './ImageLeft.png';
import rightImage from './ImageRight.png';
...
const AboutUsTop: FunctionComponent = () => {
  return (
    <div className={styles.container}>
      <img className={styles.leftImage} src={leftImage} alt="people working in an office" />
      ...
      <img className={styles.rightImage} src={rightImage} alt="people working in an office" />
      <BackgroundSvg />
    </div>
  );
};
