 ...
 = ({ size = 'medium', placeholderText, onChange, type = 'text',
   ...
   return (
     <form>
       {icon && (
         <button
           type="button" className={classNames(styles.svgButton, {
             ...
             [styles.mediumSvgButton]: size === 'medium',
             [styles.largeSvgButton]: size === 'large',
           })}
         >
       ...
       {value.length > 0 && (
         <button
           type="reset" onClick={handleClick} className={classNames(styles.eraseButton, {
             [styles.smallEraseButton]: size === 'small',
             [styles.mediumEraseButton]: size === 'medium',
             [styles.largeEraseButton]: size === 'large',
           })}
         >
           <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
